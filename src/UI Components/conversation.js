...
function Conversation() {
    ...
    useEffect(() => {
        const fetchMessages = async () => {
            try {
                const response = await fetch("https://eco-textile-app-back-end.onrender.com:8000/getMessages", {
                    method: "POST",
                    headers: {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            if (uploadedImage) {
                ...
                const imageResponse = await fetch("https://eco-textile-app-back-end.onrender.com:8000/predict", {
                    method: "POST",
                    body: formData,
                });
            ...
            const response = await fetch("https://eco-textile-app-back-end.onrender.com:8000/ask", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
                        ...
                        {messages.map((msg, index) => (
                            <React.Fragment key={index}>
                                ...
                                >
                                    ...
                                    {msg.image && (
                                        <img
                                            src={`https://eco-textile-app-back-end.onrender.com/${msg.image}`}
                                            alt="Uploaded"
                                            style={{
                                                maxWidth: "100%",
                                                maxHeight: "150px",
